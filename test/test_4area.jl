...
opfm, pf, Pc, Pcc, Pccx = SCOPF.run_decomposition(SCOPF.PCSC, system, voll, prob, contingencies, max_shed=1.0, 
...
for i in 0.5:0.05:1.0
    ...
    global opfm, pf, Pc, Pcc, Pccx = SCOPF.run_decomposition(SCOPF.PCSC, system, voll, prob, contingencies, max_shed=1.0, 
...
#     opfm, pf, Pc, Pcc = SCOPF.run_decomposition(SCOPF.PCSC, system, voll, prob, contingencies, max_shed=1.0, 
